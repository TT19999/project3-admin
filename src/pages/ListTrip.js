...
class ListTrip extends React.Component {
  ...
  componentDidMount() {
    axios({
        ...
        // handle success
        this.setState({
            tripList_origin: response.data.sets,
  ...
  onHandleDelete= (event) => {
    ...
    for(var i=0; i < n; i++){
      axios({
        method: 'DELETE',
        url: '/api/set/delete?token=' + localStorage.getItem("token"),
        data: {
                ...
                .map(n => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell>
                        <Link key={n.name} to={`/admin/home/postdetail/`+n.id} >{n.name}</Link>
                      </TableCell>
                      <TableCell>{n.intro}</TableCell>
                      <TableCell>{n.cards_count}</TableCell>
                      <TableCell>{n.comments_count}</TableCell>
