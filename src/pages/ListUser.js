                ...
                .map(n => {
                  return (
                    ...
                    >
                      ...
                      <TableCell>{n.sets_count}</TableCell>
                      <TableCell>{n.follower_count}</TableCell>
                      ...
                      <TableCell>
                        {n.deleted_at ? 
                        <>
                          <Button variant="contained" color="primary" onClick={()=>this.onClickUnBan(n.id)}>UnBan</Button>
                        </>
                        :
                        <>
